document.addEventListener("DOMContentLoaded", () => {
    ...
    const informes = [
        { titulo: "📊 Comparativo e atualização de dados e vendas",
             descricao: "Consiste em observar e comparar os dados de vendas por período, a fim de tomar decisões estratégicas e implementar ações com base nas informações obtidas.", link:"https://drive.google.com/file/d/1LlXXgACnRLmFQlhCOs-CQfETGUIZKfh8/view?usp=sharing"},
        ...
        { titulo: "📞 Prospeção de Clientes", link:"https://docs.google.com/spreadsheets/d/1n2oKt48gthl-YKqhKvn1OGuhpcXVH8fN1kkDiTXxSN8/edit?usp=sharing",
             descricao: "Realizar contato com clientes para oferecer serviços de indicação de produtos e suporte em procedimentos técnicos e decorativos, garantindo apoio estratégico ao time de vendas."},
