document.addEventListener("DOMContentLoaded", () => {
    ...
    const informes = [
        { titulo: "📊 Comparativo e atualização de dados e vendas",
             descricao: "Consiste em observar e comparar os dados de vendas por período, a fim de tomar decisões estratégicas e implementar ações com base nas informações obtidas.", link:"https://docs.google.com/spreadsheets/d/1FvHyltkdpz20qKOZOLjI661fLrK1VmaN/edit?usp=sharing&ouid=116549620406289476531&rtpof=true&sd=true"},
